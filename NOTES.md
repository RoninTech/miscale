...
| Erase History | `0x06 0x12 0x00 0x00` *(subscribe notify)* | `0x10 0x06 0x12 0x00 0x01` (observed on V1.0.0.12; `0x16` prefix in other firmwares) — Irreversible, ~30s physical erase |
