...
| Erase stored history | `0x06 0x12 0x00 0x00` *(subscribe notify)* | Response: `0x10 0x06 0x12 0x00 0x01` (observed; `0x16` prefix seen in other firmwares) — irreversible, ~30s physical erase |
